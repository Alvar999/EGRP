...
public OnFilterScriptInit()
{
	...
	"~w~An ~r~~k~~PED_SPRINT~ ~w~de dung hanh dong");
...
{
	SendClientMessage(playerid, COLOR_GREEN, "Lenh hanh dong:");
...
CMD:chat(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "su dung: /chat [1-7]");
	}
	return 1;
}
...
CMD:gesture(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "su dung: /gesture [1-15]");
	}
	return 1;
}
...
CMD:signal(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "su dung: /signal [1-2]");
	}
	return 1;
}
...
CMD:nobreath(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "su dung: /nobreath [1-3]");
	}
	return 1;
}
...
CMD:fallover(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "su dung: /fallover [1-5]");
	}
	}
	else
	{
...
CMD:pedmove(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "su dung: /pedmove [1-26]");
	}
	return 1;
}
...
CMD:getjiggy(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "su dung: /getjiggy [1-10]");
	}
	return 1;
}
...
CMD:stripclub(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "su dung: /stripclub [1-2]");
	}
	return 1;
}
...
CMD:reload(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "su dung: /reload [1-2]");
	}
	}
	else
	{
...
CMD:tag(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "su dung: /tag [1-2]");
	}
	return 1;
}
...
CMD:deal(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "su dung: /deal [1-2]");
	}
	return 1;
}
...
CMD:crossarms(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "su dung: /crossarms [1-4]");
	}
	return 1;
}
...
CMD:cheer(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "su dung: /cheer [1-8]");
	}
	return 1;
}
...
CMD:sit(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "su dung: /sit [1-5]");
	}
	return 1;
}
...
CMD:siteat(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "su dung: /siteat [1-2]");
	}
	return 1;
}
...
CMD:bar(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "su dung: /bar [1-5]");
	}
	return 1;
}
...
CMD:dance(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "su dung: /dance [1-4]");
	}
	return 1;
}
...
CMD:spank(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "su dung: /spank [1-4]");
	}
	return 1;
}
...
CMD:sexy(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "su dung: /sexy [1-6]");
	}
	return 1;
}
...
CMD:holdup(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "su dung: /holdup [1-2]");
	}
	return 1;
}
...
CMD:copa(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "su dung: /copa [1-9]");
	}
	return 1;
}
...
CMD:misc(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "su dung: /misc [1-3]");
	}
	return 1;
}
...
CMD:snatch(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "su dung: /snatch [1-2]");
	}
	return 1;
}
...
CMD:blowjob(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "su dung: /blowjob [1-2]");
	}
	return 1;
}
...
CMD:kiss(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "su dung: /kiss [1-6]");
	}
	return 1;
}
...
CMD:idles(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "su dung: /idles [1-15]");
	}
	return 1;
}
...
CMD:sunbathe(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "su dung: /sunbathe [1-18]");
	}
	return 1;
}
...
CMD:lowrider(playerid, params[])
{
	...
	if(IsCLowrider(GetPlayerVehicleID(playerid)))
	{
		...
		default: SendClientMessage(playerid, COLOR_WHITE, "su dung: /lowrider [1-31]");
		}
	}
	else
	{
...
CMD:carchat(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "su dung: /carchat [1-19]");
	}
	return 1;
}
